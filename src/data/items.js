...
const ITEMS = {
  ...
  a1_bone_fragment_helm: {
    ...
    tier: 1,
    zones: [1, 5],
    statBonuses: { str: 0, def: 1, hp: 3, regen: 0, atkSpeed: 0, atk: 0, agi: 2 },
    sellValue: 4,
    mergesInto: null,
  ...
  a1_hound_skull_cap: {
    ...
    tier: 1,
    zones: [1, 5],
    statBonuses: { str: 0, def: 0, hp: 0, regen: 0, atkSpeed: 0, atk: 0, agi: 3 },
    sellValue: 10,
    mergesInto: null,
  ...
  a2_patched_leather_vest: {
    ...
    tier: 1,
    zones: [6, 10],
    statBonuses: { str: 0, def: 8, hp: 26, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 10,
    mergesInto: null,
  ...
  a2_worn_travelers_boots: {
    ...
    tier: 1,
    zones: [6, 10],
    statBonuses: { str: 0, def: 3, hp: 7, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 8,
    mergesInto: null,
  ...
  a2_sharpened_cleaver: {
    ...
    tier: 2,
    zones: [11, 15],
    statBonuses: { str: 12, def: 0, hp: 0, regen: 0, atkSpeed: 0, atk: 12 },
    sellValue: 16,
    mergesInto: null,
  ...
  a2_reinforced_leather_vest: {
    ...
    tier: 2,
    zones: [11, 15],
    statBonuses: { str: 0, def: 11, hp: 36, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 18,
    mergesInto: null,
  ...
  a2_boiled_leather_hood: {
    ...
    tier: 2,
    zones: [11, 15],
    statBonuses: { str: 0, def: 7, hp: 18, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 14,
    mergesInto: null,
  ...
  a2_thick_hide_leggings: {
    ...
    tier: 2,
    zones: [11, 15],
    statBonuses: { str: 0, def: 7, hp: 21, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 15,
    mergesInto: null,
  ...
  a2_frontier_hatchet: {
    ...
    tier: 2,
    zones: [8, 15],
    statBonuses: { str: 14, def: 0, hp: 0, regen: 0, atkSpeed: 0.05, atk: 14 },
    sellValue: 35,
    mergesInto: null,
  ...
  a2_rangers_coat: {
    ...
    tier: 2,
    zones: [8, 15],
    statBonuses: { str: 0, def: 13, hp: 46, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 38,
    mergesInto: null,
  ...
  a2_scouts_halfhelm: {
    ...
    tier: 2,
    zones: [8, 15],
    statBonuses: { str: 0, def: 9, hp: 24, regen: 0.2, atkSpeed: 0, atk: 0 },
    sellValue: 32,
    mergesInto: null,
  ...
  a2_reinforced_trousers: {
    ...
    tier: 2,
    zones: [8, 15],
    statBonuses: { str: 0, def: 9, hp: 29, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 30,
    mergesInto: null,
  ...
  a3_road_wardens_hauberk: {
    ...
    tier: 3,
    zones: [16, 20],
    statBonuses: { str: 0, def: 15, hp: 50, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 24,
    mergesInto: null,
  ...
  a3_road_wardens_greaves: {
    ...
    tier: 3,
    zones: [16, 20],
    statBonuses: { str: 0, def: 10, hp: 32, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 20,
    mergesInto: null,
  ...
  a3_sentinels_blade: {
    ...
    tier: 4,
    zones: [21, 25],
    statBonuses: { str: 23, def: 0, hp: 0, regen: 0, atkSpeed: 0, atk: 23 },
    sellValue: 32,
    mergesInto: null,
  ...
  a3_sentinel_half_plate: {
    ...
    tier: 4,
    zones: [21, 25],
    statBonuses: { str: 0, def: 19, hp: 64, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 35,
    mergesInto: null,
  ...
  a3_sentinels_visage: {
    ...
    tier: 4,
    zones: [21, 25],
    statBonuses: { str: 0, def: 12, hp: 35, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 26,
    mergesInto: null,
  ...
  a3_sentinel_greaves: {
    ...
    tier: 4,
    zones: [21, 25],
    statBonuses: { str: 0, def: 12, hp: 40, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 28,
    mergesInto: null,
  ...
  a3_keepers_longsword: {
    ...
    tier: 5,
    zones: [26, 30],
    statBonuses: { str: 30, def: 0, hp: 0, regen: 0, atkSpeed: 0, atk: 30 },
    sellValue: 45,
    mergesInto: null,
  },
  a3_keepers_wardplate: {
    ...
    tier: 5,
    zones: [26, 30],
    statBonuses: { str: 0, def: 25, hp: 80, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 50,
    mergesInto: null,
  },
  a3_keepers_crown: {
    ...
    tier: 5,
    zones: [26, 30],
    statBonuses: { str: 0, def: 15, hp: 43, regen: 0.3, atkSpeed: 0, atk: 0 },
    sellValue: 38,
    mergesInto: null,
  },
  a3_keepers_legguards: {
    ...
    tier: 5,
    zones: [26, 30],
    statBonuses: { str: 0, def: 16, hp: 48, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 40,
    mergesInto: null,
  },
  a3_keepers_stride: {
    ...
    tier: 5,
    zones: [26, 30],
    statBonuses: { str: 0, def: 8, hp: 24, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 30,
    mergesInto: null,
  },
  a3_keepers_grip: {
    ...
    tier: 5,
    zones: [26, 30],
    statBonuses: { str: 10, def: 7, hp: 0, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 35,
    mergesInto: null,
  },
  a3_warm_hearthstone: {
    ...
    tier: 5,
    zones: [26, 30],
    statBonuses: { str: 0, def: 0, hp: 34, regen: 0.8, atkSpeed: 0, atk: 0 },
    sellValue: 38,
    mergesInto: null,
  },
  ...
  a3_wardens_oath: {
    ...
    tier: 5,
    zones: [22, 30],
    statBonuses: { str: 35, def: 8, hp: 0, regen: 0, atkSpeed: 0, atk: 35 },
    sellValue: 80,
    mergesInto: null,
  ...
  a3_ancient_sentinel_plate: {
    ...
    tier: 5,
    zones: [24, 30],
    statBonuses: { str: 0, def: 28, hp: 95, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 85,
    mergesInto: null,
  ...
  a3_visage_of_the_first: {
    ...
    tier: 5,
    zones: [26, 30],
    statBonuses: { str: 0, def: 18, hp: 48, regen: 0.5, atkSpeed: 0, atk: 0 },
    sellValue: 70,
    mergesInto: null,
  },
  a3_stoneguard_legplates: {
    ...
    tier: 5,
    zones: [24, 30],
    statBonuses: { str: 0, def: 19, hp: 54, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 72,
    mergesInto: null,
    thumbnail: 'legs002_stoneguardlegplates',
  },
  ...
  a3_irongrip_gauntlets: {
    ...
    tier: 5,
    zones: [22, 30],
    statBonuses: { str: 12, def: 8, hp: 0, regen: 0, atkSpeed: 0, atk: 0 },
    sellValue: 65,
    mergesInto: null,
  ...
  a3_heartstone_pendant: {
    ...
    tier: 5,
    zones: [26, 30],
    statBonuses: { str: 0, def: 4, hp: 48, regen: 1.0, atkSpeed: 0, atk: 0 },
    sellValue: 75,
    mergesInto: null,
  },
  // ── Waterskin ────────────────────────────────────────────────────
